...
export const renderTreeView = function(dependencyTreeData: DependencyTreeData | undefined) {
	...
	vscode.window.registerTreeDataProvider('framegraphExplorer-DependencyTree', new DependenciesTreeProvider(DTD));
};
