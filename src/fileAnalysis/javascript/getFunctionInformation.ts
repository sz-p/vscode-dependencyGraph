...
const getFunctionNameInObject = function(nodePath:NodePath<namedTypes.ObjectMethod>):string | undefined {
...
const getFunctionInformationFunctionDeclaration = function(functionInfo:FunctionInformation,functionName:string,FunctionDeclaration:NodePath<namedTypes.Function>,ExportNamedDeclaration:NodePath<namedTypes.ExportNamedDeclaration>|undefined):void{
...
const getFunctionInObject = function(functionInfo:FunctionInformation,functionName:string,ObjectMethod:NodePath<namedTypes.ObjectMethod>){
  functionInfo["name"] = functionName;
...
export const getFunctionInformation = function(nodePath: NodePath<namedTypes.Function>): FunctionInformation {
  ...
  if(functionName){
    getFunctionInformationFunctionDeclaration(functionInfo,functionName,FunctionDeclaration,ExportNamedDeclaration)
    ...
    && (functionName = getFunctionNameInVariableDeclarator(VariableDeclarator as NodePath<namedTypes.VariableDeclarator>))){
      getFunctionInVariableDeclarator(functionInfo,functionName,VariableDeclaration,ExportNamedDeclaration)
  }else if(ObjectProperty
    && (functionName = getFunctionNameInObject(ObjectProperty as NodePath<namedTypes.ObjectMethod>))){
      getFunctionInObject(functionInfo,functionName,ObjectProperty as NodePath<namedTypes.ObjectMethod>)
  }else if(ObjectMethod
    && (functionName = getFunctionNameInObject(ObjectMethod as NodePath<namedTypes.ObjectMethod>))){
      getFunctionInObject(functionInfo,functionName,ObjectMethod as NodePath<namedTypes.ObjectMethod>)
  }
  return functionInfo;
}
