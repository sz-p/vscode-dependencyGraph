...
const setFrameGraphConfig = function (
  section: string,
  value: any,
...
export const getEntryFileRelativePath = function (): string | undefined {
  return getFrameGraphConfig("entryFilePath")?.workspaceValue as string;
};
export const setEntryFileRelativePath = function (value: any) {
