...
const errorDom = function (props) {
  ...
  return (<div className="statusView-errorArea">
    ...
    <div>
      <TextField className="statusView-inputBox" label="Entry file" required prefix={folderPath} onChange={(e, v) => { console.log(e); console.log(v); setEntryFilePath(v) }} value={entryFilePath} />
